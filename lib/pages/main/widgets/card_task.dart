                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              (task.name ?? '--:--'),
                              style: TextStyle(
                                  color: task.status == StatusType.DONE.name
                                      ? AppColor.brown.withValues(alpha: 0.68)
                                      : AppColor.dark500,
                                  fontWeight: FontWeight.w500,
                                  fontStyle: task.status == StatusType.DONE.name
                                      ? FontStyle.italic
                                      : FontStyle.normal),
                            ),
                          ),
                          ...
                          if (onEdit != null)
                            IconButton(
                              ...
                              icon: const Icon(Icons.edit,
                                  size: iconSize, color: AppColor.orange),
                            ),
                          if (onRestore != null)
                            IconButton(
                              onPressed: onRestore,
                              icon: const Icon(Icons.restore,
                                  size: iconSize, color: AppColor.green),
                            ),
                          IconButton(
                            onPressed: onDeleted,
